// Credits for Markdown code block highlighting:
...
/* eslint-disable */
// lazy to deal with the warnings right now
  ...
  const CopyButton = (buttonProps) => {
    ...
    return (
      <button
        ...
        onClick={() => {
          navigator.clipboard.writeText(buttonProps.content);
          setText('Copied!');
          setTimeout(() => {
            setText('Copy');
          }, 1000);
  ...
  return (
    <div className="gatsby-highlight">
      <Highlight
        ...
        theme=""
      >
        {({ clsName, tokens, getLineProps, getTokenProps }) => (
